...
__doc__ = """
Symmetric 3D U-Net w/ Residual skip connections
...
in_spec = dict(input=(1, 16, 160, 160))
out_spec = collections.OrderedDict(mito=(1, 16, 160, 160))
width = [32, 40, 80]
InstantiatedModel = Model(in_spec, out_spec, width=width)
